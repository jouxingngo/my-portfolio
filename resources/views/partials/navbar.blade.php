  ...
  <nav class="py-4 bg-white sticky shadow-sm dark:bg-[#0d2438] top-0  ">
    <div class="container md:px-12 md:flex md:items-center md:justify-between">
        ...
        <ul class="p-5 z-10 absolute  backdrop-blur w-full left-0 py-4 opacity-0 top-[-400px] transition-all ease-in duration-500 md:p-0 md:flex md:items-center md:space-x-8 md:static md:w-auto md:opacity-100">
            <li class="md:my-0">
                <a href="#home" class="font-medium text-xl  duration-500 dark:text-white text-slate-900 hover:text-primary dark:hover:text-primary" aria-current="page">Home</a>
            </li>
            <li class="my-6 md:my-0">
                <a href="#project" class="font-medium text-xl duration-500 dark:text-white text-gray-900 hover:text-primary dark:hover:text-primary" aria-current="page">Projects</a>
            </li>
            <li class="my-6 md:my-0">
                <a href="#contact" class="font-medium text-xl duration-500 dark:text-white text-gray-900 hover:text-primary dark:hover:text-primary" aria-current="page">Contact</a>
            </li>
            
            <li class="block md:hidden">
                <a href="mailto:jouxing66@gmail.com" class=" text-white bg-primary font-medium rounded-lg text-lg px-6 py-3 text-center hover:bg-indigo-700 hover:drop-shadow-md transition duration-300 ease-in-out">Hire Me</a>
            </li>
