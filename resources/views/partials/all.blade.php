            ...
            <div class="flex w-full mx-4 py-4 flex-wrap items-center ">
                ...
                <form class="inline-flex items-center  w-full" id="search-form" method="GET" action="{{ route('project.search') }}">
                    <div class="text-center sm:text-left  me-2 sm:my-0">
                        <a href="/" class="text-white bg-indigo-600 font-medium rounded-lg text-md px-4 py-[14px] hover:bg-indigo-700 hover:drop-shadow-md transition duration-300 ease-in-out">
                    ...
                    <div class="relative w-full flex-grow">
                        ...
                        <input autocomplete="off" type="search" id="default-search" name="search" class="block w-full focus:outline-none p-3 pl-10 text-sm text-gray-900 bg-gray-50 focus:ring-2 dark:text-gray-50 dark:bg-[#102c45] rounded-md transition duration-200" placeholder="Search project by title..." />
                    </div>
                    <button type="submit" class="flex items-center justify-center px-4 py-[14px] bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200 ml-2">
                        <i class="fa fa-search"></i>
                    </button>
                    <button class="flex items-center justify-center px-4 py-[14px] bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 transition duration-200 ml-2">
