<!-- Contact Section -->
<section id="contact" class="pb-12 text-center">
    ...
    <ul class="flex justify-center text-3xl  text-gray-400  space-x-6">
        <li class="bg-gray-50 dark:bg-[#1d4065]/30 p-6 flex transition duration-500 hover:text-primary justify-center items-center  rounded-lg w-10 h-10">
            <a href="https://github.com/jouxingngo" target="_blank" >
                <i class="fab fa-github"></i>
            </a>
        </li>
        <li class="bg-gray-50 dark:bg-[#1d4065]/30 p-6 flex hover:text-primary transition duration-500 ease-in-out justify-center items-center  rounded-lg w-10 h-10">
            <a href="https://www.instagram.com/jouxing_ngo" target="_blank">
